...
class BlackjackControllerTest {
    ...
    @Test
    public void startGameResultsInInitialDealToPlayer() throws Exception {
    ...
    @Test
    public void playerHitsAndGoesBustThenRedirectsToDonePage() throws Exception {
    ...
    @Test
    public void standCommandResultsInRedirectAndPlayerIsDone() throws Exception {
        Game game = new Game(StubDeck.playerStandsAndBeatsDealer());
        BlackjackController blackjackController = new BlackjackController(game);
        blackjackController.startGame();
    ...
    @Test
    public void playerDealtBlackjackImmediatelyRedirectsToDonePage() throws Exception {
